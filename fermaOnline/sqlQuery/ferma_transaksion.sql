...
--
-- Table structure for table `transaksion`
--

DROP TABLE IF EXISTS `transaksion`;
...
CREATE TABLE `transaksion` (
  ...
  CONSTRAINT `fk_id_klienti_transaksion` FOREIGN KEY (`id_perdoruesi`) REFERENCES `perdorues` (`guid_id`) ON DELETE CASCADE ON UPDATE CASCADE
